...
if (isset($_POST['deposit'])) {
    ...
    //Notication
    $notification_details = "$client_name Has Deposited INR. $transaction_amt To Bank Account $account_number";
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item"><a href="pages_deposits">HDB Finances</a></li>
                                    ...
                                    <form method="post" enctype="multipart/form-data" role="form">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class=" col-md-6 form-group">
                                                    <label for="exampleInputPassword1">Amount Deposited(INR.)</label>
