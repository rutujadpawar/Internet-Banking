                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-3 col-6">
                      <div class="description-block">
                        <h5 class="description-header">INR. <?php echo $TotalBalInAccount; ?> </h5>
                        <span class="description-text">TOTAL MONEY IN BANK Account</span>
                      </div>
                      <!-- /.description-block -->
                    </div>
                  </div>
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                            ...
                            <td>INR. <?php echo $row->transaction_amt; ?></td>
