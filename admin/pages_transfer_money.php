...
if (isset($_POST['deposit'])) {
    ...
    //Notication
    $notification_details = "$client_name Has Transfered INR. $transaction_amt From Bank Account $account_number To Bank Account $receiving_acc_no";
    ...
    if ($transaction_amt > $amt) {
        $transaction_error  =  "You Do Not Have Sufficient Funds In Your Account For Transfer Your Current Account Balance Is INR. $amt";
    } else {
