            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1><?php echo $row->client_name; ?> HDB Account Balance</h1>
                            </div>
                            <div class="col-sm-6">
                            ...
                            <div class="col-12">
                                ...
                                <div id="balanceSheet" class="invoice p-3 mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <h4>
                                                <i class="fas fa-bank"></i> HDB Financial Corporation Balance Enquiry
                                        ...
                                        <div class="col-12 table-responsive">
                                            <table class="table table-hover table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>INR. <?php echo $deposit; ?></td>
                                                        <td>INR. <?php echo $withdrawal; ?></td>
                                                        <td>INR. <?php echo $Transfer; ?></td>
                                                        <td>INR. <?php echo $money_in; ?></td>
                                                    </tr>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-hover">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>INR. <?php echo $rate_amt; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <th>Total Balance:</th>
                                                        <td>INR. <?php echo $totalMoney; ?></td>
                                                    </tr>
                                                </table>
                                            </div>
                                        </div>
